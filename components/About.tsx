  ...
  return (
    <section id="nosotros" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        {/* Historia */}
        <div className="mb-20">
          <h2 className="text-4xl md:text-5xl font-display text-center mb-12 text-brand-black">Nuestra Historia</h2>
          <div className="relative border-l-4 border-brand-yellow ml-4 md:ml-auto md:mr-auto md:w-2/3 pl-8 space-y-12">
            <div className="relative">
              <div className="absolute -left-[42px] top-0 bg-brand-red w-6 h-6 rounded-full border-4 border-white"></div>
            ...
            <div className="relative">
              <div className="absolute -left-[42px] top-0 bg-brand-yellow w-6 h-6 rounded-full border-4 border-white"></div>
        ...
        {/* Misión */}
        <div className="bg-brand-yellow/10 rounded-3xl p-12 text-center mb-20">
          <div className="bg-brand-yellow w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
            <Rocket className="text-brand-black w-10 h-10" />
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {values.map((val, idx) => (
              <div key={idx} className="bg-gray-50 p-6 rounded-xl flex flex-col items-center text-center hover:shadow-md transition-shadow">
